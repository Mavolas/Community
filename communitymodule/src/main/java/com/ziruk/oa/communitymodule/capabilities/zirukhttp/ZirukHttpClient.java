package com.ziruk.oa.communitymodule.capabilities.zirukhttp;
...
import com.ziruk.oa.communitymodule.capabilities.zirukhttp.response.CommonJsonResponse;
import com.ziruk.oa.communitymodule.capabilities.zirukhttp.utils.HttpsUtils;
...
public class ZirukHttpClient {
    ...
    private volatile static ZirukHttpClient mInstance;
    ...
    public static class Builder{
        ...
        public Builder url(String actionUrl){
            ...
            if ( StringUtils.isBlank(urlRoot)) {
                 urlRoot = HttpsUtils.getURLRoot(mContext);
            }
